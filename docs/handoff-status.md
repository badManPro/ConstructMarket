...
当前项目停在“浏览、交易、内容与服务链路已实现，且 UI 视觉规则已切换到 `docs/pencil` 主导；剩余明显占位页集中在分类页和个人中心补全，以及开发者工具联调”的阶段。
...
1. 分类页真实内容
2. 我的页真实用户卡、订单摘要和服务入口整理
3. 收藏夹页与个人信息页真实内容
4. 微信开发者工具联调和视觉验收

推荐顺序：

1. 先补分类页真实内容，并沿用 `docs/ui-reference-guideline.md`
2. 再补我的页、收藏夹页、个人信息页和交易链路边界态联调
3. 最后做微信开发者工具联调和视觉验收
