...
当前项目停在“浏览、交易、内容与服务链路已实现，且 UI 视觉规则已切换到 `docs/pencil` 主导；分类页已补成真实内容，剩余明显占位页集中在个人中心补全和开发者工具联调”的阶段。
...
1. 我的页真实用户卡、订单摘要和服务入口整理
2. 收藏夹页与个人信息页真实内容
3. 微信开发者工具联调和视觉验收

推荐顺序：

1. 先补我的页真实用户卡、订单摘要和服务入口整理，并沿用 `docs/ui-reference-guideline.md`
2. 再补收藏夹页、个人信息页和交易链路边界态联调
3. 最后做微信开发者工具联调和视觉验收
