...
const baseProducts: SearchProduct[] = [
  {
    id: "p-floor-001",
    spuId: "spu-floor-001",
    skuId: "sku-floor-001",
...
const detailMap: Record<string, BrowseProductDetail> = {
  "p-floor-001": {
    ...baseProducts[0],
...
export const hotSearchKeywords = ["42.5R 水泥", "工程地砖", "PPR 水管", "阻燃电线"];

export const homeBanners: BannerCard[] = [
  {
    id: "banner-01",
    eyebrow: "工程主材周",
    title: "地砖与辅材组合采购",
...
export const priceFilterOptions: FilterOption[] = [
...
export const minOrderFilterOptions: FilterOption[] = [
...
export const materialFilterOptions: FilterOption[] = [
...
function withFavoriteState<T extends { id: string; isFavorite: boolean }>(items: T[], favoriteIds: string[]) {
...
export function getHomeSections(favoriteIds: string[]) {
  return {
...
export function getProductDetail(productId: string, favoriteIds: string[]) {
  const detail = detailMap[productId] ?? detailMap["p-floor-001"];
  return withFavoriteState([detail], favoriteIds)[0];
}

export function getRecommendedProducts(productId: string, favoriteIds: string[]) {
  const detail = detailMap[productId] ?? detailMap["p-floor-001"];
